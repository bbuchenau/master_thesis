### This script uses the color histogram and gradients of images to detect ###
### images that are most likely animated / cartoons and sorts them out. ###
...
for filename in os.listdir(folder_path):
    ...
    # Calculate number of unique colors in the image.
