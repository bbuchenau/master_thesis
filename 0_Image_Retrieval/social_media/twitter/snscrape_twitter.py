### This script uses a scraping library called snscrape to retrieve images from Twitter. ###
### UPDATE 09/2023: Due to constant changes in Twitter code that make scraping impossible, I am mainly using Instagram instead! ###
