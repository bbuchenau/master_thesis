### This script uses an unreleased snscrape fix to scrape Instagram images ###
### by geolocation. The images are just mostly as the model test datasets. ###
...
# The scraping extracts the latest images from the geolocation id, but is limited.
# Scrape interval set for screen session to automatically scrape every 12 hours.
